    ...
    >
      <div className='w-full max-w-full min-w-0 space-y-2.5 overflow-x-hidden py-1 sm:space-y-3'>
        ...
        {/* ===== CUSTOM START: hide actual (upstream) model from log details =====
            Upstream renders a "Model Mapping" section here with "Request Model"
            and "Actual Model" rows. Removed so clients only see the model name
            they requested, never the post-redirect upstream model.
            ===== CUSTOM END ===== */}
